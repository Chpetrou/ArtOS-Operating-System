...
/** Read out time stamp counter
 *
 * The rdtsc asm command puts a 64 bit time stamp value
 * into EDX:EAX.
 *
 * The 64 bit time stamp value
 */
 ...
 * is used here.
 *
 * msr The parameter which rdmsr assumes in ECX
 * The value rdmsr put into EDX:EAX
 */
...
/** Write a value to a  Machine-Specific Registers (MSR)
 *
 * The asm instruction wrmsr which stands for "Write to model specific register"
 * is used here.
 *
 * msr The MSR identifier
 * value Value, which will be store in the MSR
 */
...
/** Write a value into cr0 register
 * val The value you want to write into cr0
 */
...
/** Write a value into cr2 register
 * val The value you want to write into cr2
 */
...
/** Write a value into cr3 register
 * val The value you want to write into cr3
 */
...
/** Write a value into cr4 register
 * val The value you want to write into cr4
 */
...
/** Flush a specific page entry in TLB
 * addr The (virtual) address of the page to flush
 */
 ...
 *
 * code Input parameter for the cpuid instruction. Take a look into the intel manual.
 * a EAX value will be stores here
 * b EBX value will be stores here
 * c ECX value will be stores here
 * d EDX value will be stores here
 */
...
/** Detect and read out CPU frequency
 *
 * The CPU frequency in MHz
 */
uint32_t detect_cpu_frequency(void);

/** Read out CPU frequency if detected before
 *
...
/** Busywait an microseconds interval of time
 * usecs The time to wait in microseconds
 */
